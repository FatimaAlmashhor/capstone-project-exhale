...
// import Svg1 from '../../Lottie/writing-an-exam.json'
// import Svg2 from '../../Lottie/heartbeating.json'
    ...
    <div>
      ...
      /> */}
            ...
            <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div className="md:pr-4">
                ...
                <h3 className="text-3xl font-semibold text-green-600">What we do</h3>
      ...
      <section className="mt-40 pb-20 py-10 relative bg-gray-200">
        ...
        <div className="md:flex md:flex-wrap -mb-4">
          <div className="mb-4  sm:w-1  md:w-1/3 ">
            <TeamCard />
          </div>
          <div className="mb-4  sm:w-1  md:w-1/3 ">
            <TeamCard />
